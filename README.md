...
--        | --            | -- | --          | -- | -- | -- | --
| 2022 | [Medical Insurance_Prediction](https://github.com/precious-azun/Lung_Cancer_Prediction/blob/main/Lung_cancer_prediction.ipynb)|[Lung_cancer.csv](https://github.com/precious-azun/medical_insurance/blob/main/insurance.csv) |Supervised (Classification) |  KNN, LOG.R, DT , SVM |  Python Pandas Numpy Seaborn Matplotlib Sklearn Scikit-learn | :hourglass:  | :hourglass: 
